...
Drift Souls is a racing game with combat inspired by Dark Souls. Players race against other drivers while also engaging in combat, with the ability to parry collisions and attacks to gain speed boosts.
...
### Saira Stencil
- Authors: The Saira Stencil Project Authors
- License: SIL Open Font License 1.1
- Source: [https://github.com/Omnibus-Type/Saira/SairaStencil](https://github.com/Omnibus-Type/Saira/SairaStencil)
- License File: `SairaStencil-OFL.txt`

### Share
- Authors: Carrois Type Design, Ralph du Carrois
- License: SIL Open Font License 1.1
